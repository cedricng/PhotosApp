...
<div class="container">
    <div class="row">
        ...
        <div class="col-9 pt-5">
            ...
            <div class="d-flex">
                <div class="pt-4"><strong>{{ $postCount }}</strong> posts</div>
                <div class="p-4"><strong>{{ $followersCount }}</strong> followers</div>
                <div class="pt-4"><strong>{{ $followingCount}}</strong> following</div>
            </div>
